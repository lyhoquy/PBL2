...
void CustumerType3::Upgrade(CustumerType2& ct2){
    ...
    int remainingPrice;
    remainingPrice = ct2.GetPackage().PriceEachMonth * remainingMonths;
    ...
    else{ std::cout << "So tien du la: " << totalPrice << " VND" << std::endl;}
    upgrade[std::stoi(month)-1]+= abs(totalPrice);
